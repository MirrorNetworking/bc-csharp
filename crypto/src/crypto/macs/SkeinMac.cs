...
namespace Mirror.BouncyCastle.Crypto.Macs
{
	...
	/// based on the <see cref="Mirror.BouncyCastle.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
		...
		: IMac
	{
		...
		/// </summary>
		/// See <see cref="Mirror.BouncyCastle.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
